 ...
 */
@Slf4j
public class DecompressFramesOutput extends DecompressSupport implements StreamingResponseBody
{
    ...
    public DecompressFramesOutput(Path inst, int[] frameList, Path spoolDirectory) {
        super(inst);
